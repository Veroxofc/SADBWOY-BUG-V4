...
async function handleLinkDetection(sock, chatId, message, userMessage, senderId) {
    ...
    if (shouldDelete) {
        ...
        await sock.sendMessage(chatId, { text: `KEEP SENDING LINKS  AND YOU WILL SEE YOURSELF OUTSIDE @${senderId.split('@')[0]}, posting links is not allowed.`, mentions: mentionedJidList });
    } else {
